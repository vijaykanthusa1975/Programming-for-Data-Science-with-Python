...
listOfCities = ['chicago', 'nyc', 'washington']
...
def time_stats(df):
    ...
    print('Most common month: ', statistics.mode(df['Start Time'].dt.month))
    	
    # display the most common day of week
    print('Most common day of week: ', statistics.mode(df['Start Time'].dt.weekday_name))

    # display the most common start hour
    print('Most common hour: ', statistics.mode(df['Start Time'].dt.hour))
...
def user_stats(df,city):
    ...
    if city.lower()!='washington':
        ...
        print("Earliest, most recent, and most common year of birth: \n", int(df['Birth Year'].min()), int(df['Birth Year'].max()),int(statistics.mode(df['Birth Year'])))
...
def station_stats(df):
    ...
    print("Most commonly used start station: ", statistics.mode(df['Start Station']))

    
    # display most commonly used end station
    print("Most commonly used end station: ", statistics.mode(df['End Station']))
